...
export const heroSection: HeroSectionType = {
  ...
  title: 'Nilesh Rana.',
  tagline: 'I build modern, user-focused web solutions that turn ideas into innovation.',
  description:
  ...
  specialText: 'Available for Freelance | Internship | Full-Time Opportunities.',
  cta: {
    title: 'see my resume',
    url: `/${resumeFileName}`,
    hideInDesktop: true,
